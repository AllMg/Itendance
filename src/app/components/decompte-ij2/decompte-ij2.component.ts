...
@Component({
  selector: 'app-decompte-ij2',
  templateUrl: './decompte-ij2.component.html',
  styleUrls: ['./decompte-ij2.component.css']
})
export class DecompteIj2Component implements OnInit {
  idDmdIJ: string;
  dmdIJ: any;
  decompte: any;
  employeur: any;
